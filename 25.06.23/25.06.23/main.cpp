...
int main() {
	setlocale(LC_ALL, "ru");
	Passport passport1("Азербайджан", "Фамиль", "Гараханлы", "Джейхун", "09.06.2007", "Баку", "Мужской", 16);
	passport1.Print();
	cout << "==================================" << "\n";
	ForeignPassport passport2("Азербайджан", "Фамиль", "Гараханлы", "Джейхун", "25.01.2007", "Баку", "Мужской", 16, 4444654, 416973);
	passport2.Print();
